...
typedef BaseReactPlayerProps = {
	@:optional
	var url : ts.AnyOf4<String, Array<String>, Array<SourceProps>, js.html.MediaStream>;
	@:optional
	var playing : Bool;
	@:optional
	var loop : Bool;
	...
	@:optional
	dynamic function onProgress(state:OnProgressProps):Void;
};